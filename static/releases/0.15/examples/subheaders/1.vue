    ...
    data () {
      return {
        items: [
          { header: 'Today' },
          {
            avatar: '/images/examples/lists/1.jpg',
          ...
          {
            avatar: '/images/examples/lists/2.jpg',
          ...
          { divider: true, inset: true },
          {
            avatar: '/images/examples/lists/5.jpg',
            title: 'Recipe to try',
